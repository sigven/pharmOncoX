...
#'
#' @format \bold{oncopharmadb} - A data frame with 575,264 rows and 49 columns:
#' \itemize{
...
#'
#' @format \bold{compound_synonyms} - A data frame with 157,016 rows and 3 columns:
#' \itemize{
...
#'
#' @format \bold{curated} - A data frame with 298,302 rows and 26 columns:
#' \itemize{
...
#'
#' @format \bold{druggable} - A data frame with 986 rows and 6 columns:
#' \itemize{
