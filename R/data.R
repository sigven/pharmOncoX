...
#'
#' @format \bold{oncopharmadb} - A data frame with 574,081 rows and 49 columns:
#' \itemize{
...
#'
#' @format \bold{compound_synonyms} - A data frame with 507,425 rows and 3 columns:
#' \itemize{
...
#'
#' @format \bold{curated} - A data frame with 295,336 rows and 26 columns:
#' \itemize{
...
#'
#'
#' @format \bold{invitro_screen} - A data frame with 25,793 rows and 8 columns:
#' \itemize{
...
#'
#' @format \bold{druggable} - A data frame with 1,100 rows and 6 columns:
#' \itemize{
